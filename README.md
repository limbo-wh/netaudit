...
Скачайте архив из [Releases](../../releases), распакуйте и запустите `NetAudit.App.exe` —
никакого отдельного установщика запускать не нужно.
...
приложений на .NET, не часть NetAudit. Ярлык на рабочем столе предложит
создать само приложение при первом запуске.
